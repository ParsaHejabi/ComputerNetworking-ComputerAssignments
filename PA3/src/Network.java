...
public class Network {
     ...
     * @throws java.lang.NumberFormatException Thrown when a numeric
     ...
     * @param t A string tokenizer object representing the line from the
     *          .net file with the first token (the command) already removed.
     * @throws NoSuchLinkException             Thrown when a link description
     ...
     * @param t A string tokenizer object representing the line from the
     *          .net file with the first token (the command) already removed.
     * @throws NoSuchLinkException Thrown when an event description
